...
(function () {
  ...
  /* ============================================================
     ...
     If Firebase is not configured yet (assets/firebase-config.js
     still has placeholder keys) or the SDK failed to load, we
     fall back to opening the visitor's email app with a
     pre-filled message so no lead is ever lost — and we clearly
     tell the user what happened instead of faking a success.
     ============================================================ */
